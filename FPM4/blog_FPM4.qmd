...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("images", "plume2.png"))
plot(as.raster(img))
```
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("images", "global-temperature-anomalies-by-month.png"))
plot(as.raster(img)) 
```
...
#| echo: false
#| eval: true
infographic <- readJPEG(here::here("final_figs", "FPM4.4.jpg"))
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("outputs", "sector_plot_ss.png"))
plot(as.raster(img))
...
gas_total_emissions / gas_gwp_plot
```
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("outputs", "emission_gwp_ss.png"))
plot(as.raster(img))
```
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("outputs", "country_ss.png"))
plot(as.raster(img))
```
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("images", "orange_purple_colors.png"))
plot(as.raster(img))
```
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("images", "sector_colors.png"))
plot(as.raster(img))
```
...
#| echo: false
#| eval: true
img <- png::readPNG(here::here("images", "country_colors.png"))
plot(as.raster(img))
```
